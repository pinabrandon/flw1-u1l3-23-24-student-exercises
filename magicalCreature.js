...
let creatureDescription= "a reptile that breathes fire";
...
let zooSummary = "The " + creaturename + "is  " + creatureDescription + ". it is "+ isfriendly + " and it is " + visitorAge + " years old.";
